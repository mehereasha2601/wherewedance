...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Where We Dance — Boston Bachata Guide" },
      ...
      { property: "og:title", content: "Where We Dance — Boston Bachata Guide" },
      ...
      { name: "twitter:title", content: "Where We Dance — Boston Bachata Guide" },
