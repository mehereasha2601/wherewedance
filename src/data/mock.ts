...
export const organizers: Organizer[] = [
  ...
  },
  {
    ...
    typeFilter: "Dance studio",
    bestFor: "Brand-new dancers, structured Salsa/Bachata classes, safe technique, no partner needed",
...
export const resources: Resource[] = [
  // ---- Group chats (private, listed for awareness only) ----
  {
    id: "res-sensualeros-whatsapp",
    name: "Sensualeros WhatsApp group",
    category: "Group chats",
    privacyStatus: "Private group",
    description: "Private/community-known WhatsApp group for Sensual Bachata-related local updates and conversation.",
    ...
    tags: ["WhatsApp", "Sensual Bachata", "Private group"],
  },
  {
  ...
  {
    id: "res-dj-bat-whatsapp",
    name: "DJ Bat WhatsApp group",
    category: "Group chats",
    privacyStatus: "Private group",
    description: "Community-known WhatsApp group connected to DJ Bat / Boston Bachata updates.",
    howToJoin: "Ask DJ Bat or a trusted community member for an invite.",
    instagramUrl: "https://www.instagram.com/djbatlive/",
    sourceStatus: "Community-known / private group",
    lastVerified: "2026-06-03",
    sourceUrl: "https://www.instagram.com/djbatlive/",
    tags: ["WhatsApp", "Music", "Event updates", "Private group"],
  },
  ...
  // ---- Playlists ----
  {
    ...
    description: "Public practice music page from J&L Dance Studio with Bachata and Salsa practice music sections.",
  ...
  },
  {
    ...
    lastVerified: "2026-06-03",
    sourceUrl: "https://www.instagram.com/djbatlive/",
    tags: ["Music", "Playlist", "Needs validation"],
  },
  ...
  // ---- Online classes ----
  {
    ...
    privacyStatus: "Public link",
    description: "Online Bachata training resource with step-by-step lessons covering partnerwork, footwork, body movement, musicality, and styling.",
    howToJoin: "Open the public website and choose a course/free mini-course if interested.",
  ...
  // ---- Blog posts / WhereWeDance guides ----
  {
  ...
  },
  {
    ...
    category: "Safety / values",
    privacyStatus: "Public link",
    description: "Community education and social dance culture resource. Listed for community conversations on consent, communication, belonging, and safer-floor topics.",
    howToJoin: "Follow on Instagram for community education and conversations.",
    instagramUrl: "https://www.instagram.com/starryboston/",
    sourceStatus: "From public listing",
    lastVerified: "2026-05-20",
    sourceUrl: "https://www.instagram.com/starryboston/",
    tags: ["Community education", "Consent", "Safer floor"],
  },

  // ---- Competitions ----
  {
    id: "res-flow-competition",
    name: "Flow Bachata Competition",
    category: "Competitions",
    privacyStatus: "Needs validation",
    description: "Bachata competition associated with Flow Studios. Format, dates, and divisions need to be confirmed before listing as public.",
    howToJoin: "Check Flow Studios for current competition details.",
    websiteUrl: "https://flowstudios.dance/",
    instagramUrl: "https://www.instagram.com/flowstudios.dance/",
    sourceStatus: "Needs validation",
    lastVerified: "2026-06-03",
    sourceUrl: "https://flowstudios.dance/",
    tags: ["Competition", "Bachata", "Needs validation"],
  },
  ...
  // ---- Organizers ----
  {
    ...
    category: "Organizers",
    privacyStatus: "Public link",
    description: "Boston-based inclusive dance community/team founded by Tina Cavicchio, centering inclusion, access, safety, creativity, and empowerment, especially for queer/trans/LGBTQIA+ dancers.",
    howToJoin: "Open the public website or Instagram.",
    websiteUrl: "https://www.nextlevelfusiondance.com/",
    instagramUrl: "https://www.instagram.com/nextlevelfusion/",
    sourceStatus: "From public listing",
    lastVerified: "2026-05-22",
    sourceUrl: "https://www.nextlevelfusiondance.com/",
    tags: ["Queer-inclusive", "Community", "Bachata/Salsa-adjacent"],
  },
  {
    id: "res-bobas",
    ...
    category: "Organizers",
    privacyStatus: "Public link",
    description: "Community-led free outdoor Salsa/Bachata pop-ups at the Charles River Dock. Weather-dependent and usually announced on Instagram shortly before the event.",
    howToJoin: "Follow Instagram for pop-up announcements.",
    instagramUrl: "https://www.instagram.com/bobas.dance/",
    facebookUrl: "https://www.facebook.com/p/Boston-Outdoor-Bachata-And-Salsa-61551665503735/",
    sourceStatus: "From public listing",
    lastVerified: "2026-06-03",
    sourceUrl: "https://www.instagram.com/bobas.dance/",
    tags: ["Outdoor", "Pop-up", "Free"],
  },
  {
  ...
  },
  {
    ...
    category: "Studios",
    privacyStatus: "Public link",
    description: "Latin social club at 288 Green St, Central Square, Cambridge. Runs Latin nights Mon, Tue, Thu, Fri, Sat, Sun, with lessons before the social on operating nights.",
    howToJoin: "Check the official Havana Club page before going.",
    websiteUrl: "https://havanaclubsalsa.com/",
    facebookUrl: "https://www.facebook.com/HavanaClubBoston/",
    sourceStatus: "From public listing",
    lastVerified: "2026-06-03",
    sourceUrl: "https://havanaclubsalsa.com/",
    tags: ["Venue", "Lessons before social", "Bachata-heavy nights"],
  },
  {
    id: "res-bachata-room",
    name: "The Bachata Room",
    category: "Studios",
    privacyStatus: "Public link",
    description: "Bachata-heavy Wednesday night focused on traditional and modern bachata, with a beginner class before the social.",
    howToJoin: "Check the official site or Instagram for class details.",
    websiteUrl: "https://www.bachataroomboston.com/",
    instagramUrl: "https://www.instagram.com/bachataroom/",
    sourceStatus: "From public listing",
    lastVerified: "2026-06-03",
    sourceUrl: "https://www.bachataroomboston.com/",
    tags: ["Bachata-first", "Wednesday"],
  },
  {
    id: "res-jl",
    name: "J&L Dance Studio",
    category: "Studios",
    privacyStatus: "Public link",
    description: "Malden/Boston-area Latin dance studio/community known for structured classes and events. Schedules can change - check the official source before going.",
    howToJoin: "Open the public website or Instagram for current classes.",
    websiteUrl: "https://jandldancestudio.com/",
    instagramUrl: "https://www.instagram.com/jl_dancestudio/",
    sourceStatus: "From public listing",
    lastVerified: "2026-06-03",
    sourceUrl: "https://jandldancestudio.com/classesoffered",
    tags: ["Studio", "Structured classes"],
  },
  {
    id: "res-lili",
    name: "Lili Latin Dance",
    ...
    howToJoin: "Open the public website for class schedule.",
    websiteUrl: "https://www.lili.dance/",
    instagramUrl: "https://www.instagram.com/lililatindance/",
    sourceStatus: "From public listing",
    lastVerified: "2026-06-03",
    sourceUrl: "https://www.lili.dance/",
    tags: ["Beginner-friendly", "Somerville"],
  },
  {
    ...
    category: "Studios",
    privacyStatus: "Public link",
    description: "Greater Boston Latin dance studio/company offering Salsa, Bachata, and other Latin dance classes for complete beginners through more advanced dancers.",
    howToJoin: "Open the public website for current classes.",
    websiteUrl: "https://www.rumbaytimbal.com/",
    instagramUrl: "https://www.instagram.com/rumbaytimbal/",
    facebookUrl: "https://www.facebook.com/rumbaytimbalboston/",
    sourceStatus: "From public listing",
  ...
  },
  {
    ...
    tags: ["Studio", "Salsa-first", "Performance teams"],
  },
  {
    ...
    category: "Studios",
    privacyStatus: "Needs validation",
    description: "Offers Sensual Bachata, Brazilian Zouk, Forró, Kizomba, Samba, and related partner dance classes in Boston/Cambridge. Studio 44, 44 5th Street, Cambridge per public listing - verify before going.",
    howToJoin: "Check the official site for current schedule.",
    websiteUrl: "https://movesandvibes.com/",
    sourceStatus: "Needs validation",
    lastVerified: "2026-05-22",
