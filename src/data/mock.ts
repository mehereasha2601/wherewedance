...
export const events: Event[] = [
  ...
  },
  {
    ...
    organizerId: "org-bobas",
    venue: "ICA Doc",
    address: "ICA Doc, Boston, MA — one-time location; back to Charles River Dock after this",
    dayOfWeek: "Thursday",
    startsAt: "19:20",
    endsAt: "21:00",
    popUp: true,
    thisWeek: true,
    scheduleNote: "One-time pop-up at ICA Doc — 7:20 PM start instead of usual time",
    cover: "from-mango via-magenta to-terracotta",
    bachataRelevance: "Bachata-included",
    beginnerLabel: "Beginner-welcome",
    classBeforeSocial: { offered: false, level: "No intro class unless announced" },
